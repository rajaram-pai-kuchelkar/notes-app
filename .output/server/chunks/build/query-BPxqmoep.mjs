...
import { a as useRequestEvent, u as useContentPreview } from './preview-CIgvnTXX.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CLpn4IUd.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BPxqmoep.mjs.map
