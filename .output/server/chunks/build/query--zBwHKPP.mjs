...
import { a as useRequestEvent, u as useContentPreview } from './preview-BOZu54b-.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BVGtTNo6.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query--zBwHKPP.mjs.map
