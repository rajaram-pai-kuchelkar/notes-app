import { u as useContentDisabled, a as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query--zBwHKPP.mjs';
import { b as useNuxtApp, a as useRuntimeConfig } from './server.mjs';
import { y as hash } from '../runtime.mjs';
import { u as useContentPreview } from './preview-BOZu54b-.mjs';
import { defineComponent, toRefs, computed, useSlots, useSSRContext, toRef, isRef, h } from 'vue';
import { _ as __nuxt_component_0 } from './nuxt-link-CftAvjdO.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BVGtTNo6.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BeRrAUbG.mjs.map
